                ...
                height: 104%;">
                    <div class="message-list">
                        ...
                        border: #ffffff;">
                            ...
                            <div id="chatName"></div>
                            <div class="chat" id="chat" style="height:35rem; overflow-y:auto;"><h1><b>Welcome, <?php echo e(auth()->user()->username); ?>.</b></h1>
 ...
 var $sendBtn = $('#submitmessage');
    $(function(){
        ...
        $messageForm.submit(function(e){
            e.preventDefault();
            socket.emit('send message', {message:$message.val(), roomno: $m.val(),subs_id:'<?php echo e(auth()->user()->id); ?>', con_id: $('#submitmessage').val()});
        ...
        socket.emit('login user', ['<?php echo e(auth()->user()->id); ?>', '<?php echo e(auth()->user()->username); ?>'], function(data){
            //Auto disconnect
        ...
        socket.emit('getChatPersona', '<?php echo e(auth()->user()->id); ?>', (data)=>{});

        socket.on('showName', (data)=>{
            var html = '<h4><b>'+data[0].persona_name+'</b></h4><br>';
           $chatName.html(html);
...
function logout(){
     socket.emit('logout user', ['<?php echo e(auth()->user()->id); ?>', '<?php echo e(auth()->user()->username); ?>'], function(data){
        //...
     });
}
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\NMS-Inventory-System\Team-Rocket-PSU\LoopSystem\resources\views/pages/home.blade.php ENDPATH**/ ?>